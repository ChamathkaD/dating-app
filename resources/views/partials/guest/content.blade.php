<main id="main-container">
        ...
        <div class="content content-full">
            <div class="pt-100 pb-50">
                ...
                <div class="row nice-copy my-10">
                    ...
                    <div class="col-md-4 py-20">
                        <a class="options-container push" href="db_classic.html">
                    ...
                    <div class="col-md-4 py-20">
                        <a class="options-container push" href="db_clean.html">
                    ...
                    <div class="col-md-4 py-20">
                        <a class="options-container push" href="db_social.html">
                    ...
                    <div class="col-md-4 py-20">
                        <a class="options-container push" href="db_corporate.html">
                    ...
                    <div class="col-md-4 py-20">
                        <a class="options-container push" href="db_minimal.html">
                    ...
                    <div class="col-md-4 py-20">
                        <a class="options-container push" href="db_pop.html">
                    ...
                    <div class="col-md-4 py-20">
                        <a class="options-container push" href="db_dark.html">
                            <img class="img-fluid options-item" src="assets/media/various/preview-db-dark.png" alt="Dashboard Dark">
                            <div class="options-overlay bg-white-op-90">
                                <div class="options-overlay-content h5 font-w700 text-uppercase">
                                    <i class="fa fa-link fa-4x"></i>
                                </div>
                    ...
                    <div class="col-md-4 py-20">
                        <a class="options-container push" href="db_medical.html">
                ...
                <div class="text-center">
                    <a class="btn btn-hero btn-noborder btn-alt-secondary min-width-175" href="be_pages_dashboard2.html">
            ...
            <div class="row no-gutters pull-b text-center overflow-hidden">
                <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
                    <a class="options-container" href="be_pages_dashboard.html">
                        <img class="img-fluid options-item" src="assets/media/various/landing-promo-layout-backend.png" srcset="assets/media/various/landing-promo-layout-backend@2x.png 2x" alt="Backend Promo">
                ...
                <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="250">
                    <a class="options-container" href="db_classic.html">
                        <img class="img-fluid options-item" src="assets/media/various/landing-promo-layout-classic-dashboard.png" srcset="assets/media/various/landing-promo-layout-classic-dashboard@2x.png 2x" alt="Classic Dashboard Promo">
                        <div class="options-overlay bg-white">
                            <div class="options-overlay-content">
                                <h3 class="h5 font-w700 text-uppercase mb-5">
                ...
                <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="500">
                    <a class="options-container" href="be_layout_api.html">
                        <img class="img-fluid options-item" src="assets/media/various/landing-promo-layout-api.png" srcset="assets/media/various/landing-promo-layout-api@2x.png 2x" alt="Layout API Promo">
                        <div class="options-overlay bg-white">
                            <div class="options-overlay-content">
                                <h3 class="h5 font-w700 text-uppercase mb-5">
            ...
            <div class="row no-gutters pull-b text-center overflow-hidden">
                <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
                    <a class="options-container" href="be_ui_grid.html">
                        <img class="img-fluid options-item" src="assets/media/various/landing-promo-bootstrap4-grid.png" srcset="assets/media/various/landing-promo-bootstrap4-grid@2x.png 2x" alt="Bootstrap 4 Grid Promo">
                ...
                <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="250">
                    <a class="options-container" href="be_ui_typography.html">
                        <img class="img-fluid options-item" src="assets/media/various/landing-promo-bootstrap4-typography.png" srcset="assets/media/various/landing-promo-bootstrap4-typography@2x.png 2x" alt="Bootstrap 4 Typography Promo">
                        <div class="options-overlay bg-body-light">
                            <div class="options-overlay-content">
                                <h3 class="h5 font-w700 text-uppercase mb-5">
                                    Explore
                ...
                <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="500">
                    <a class="options-container" href="be_ui_buttons.html">
                        <img class="img-fluid options-item" src="assets/media/various/landing-promo-bootstrap4-buttons.png" srcset="assets/media/various/landing-promo-bootstrap4-buttons@2x.png 2x" alt="Bootstrap 4 Buttons Promo">
                        <div class="options-overlay bg-body-light">
                            <div class="options-overlay-content">
                                <h3 class="h5 font-w700 text-uppercase mb-5">
                                    Explore
    ...
    <div class="bg-body-light">
        <div class="content content-full">
            ...
            <div class="row no-gutters pull-b text-center overflow-hidden">
                <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
                    <img class="img-fluid" src="assets/media/various/landing-promo-developer-minded-php.png" srcset="assets/media/various/landing-promo-developer-minded-php@2x.png 2x" alt="Developer Minded PHP Promo">
                </div>
                <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="250">
                    <img class="img-fluid" src="assets/media/various/landing-promo-developer-minded-docs.png" srcset="assets/media/various/landing-promo-developer-minded-docs@2x.png 2x" alt="Developer Minded Docs Promo">
                </div>
                <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="500">
                    <img class="img-fluid" src="assets/media/various/landing-promo-developer-minded-html.png" srcset="assets/media/various/landing-promo-developer-minded-html@2x.png 2x" alt="Developer Minded HTML Promo">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="pt-100 pb-50">
                ...
                <div class="row nice-copy py-10">
                    ...
                    <div class="col-md-4 py-20 text-center text-md-left">
                        ...
                        <a class="btn btn-hero btn-sm btn-alt-secondary" href="be_pages_dashboard.html">
